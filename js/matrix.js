...
function set_task_done(color1 = "transparent", color2 = "#4f7cac") {
  document.querySelectorAll(".task_done").forEach((element) => {
    element.style.backgroundColor = color1;
    text_els = element.querySelectorAll("a");
    text_els.forEach((text_el) => {
      text_el.style.color = color2;
    });
  });
}
...
function show_side_matrix() {
  ...
  document
    .getElementById("layout-options")
    .setAttribute("data-selected_layout", "side");
  save_layout();
}
...
function show_flat_matrix() {
  ...
  document
    .getElementById("layout-options")
    .setAttribute("data-selected_layout", "flat");
  save_layout();
}
...
function save_layout() {
  let saved_layout = document
    .getElementById("layout-options")
    .getAttribute("data-selected_layout");
